# Karan/Hermes Source Notes

Karan/Hermes contributed operational validation and routing work around Agent Mesh, especially the Discord Taboo mesh tests and local/direct participant routing checks.
