...
import { normalizeConfig, planDiscordBridgeTurn, planDiscordEventTaskTurn, planRuntimeAction } from "./policy.js";
...
export default definePluginEntry({
  ...
  description: "Private dry-run wrapper for the Agent Mesh sidecar",
  register(api) {
